  ...
  if($result)
  {
    ...
    if($insert_query_res)
    {
      ...
      $msg="<pre>Hello ".$to_mail."!. 
                 ...
                 http://localhost:80/project/client/forgot_pass_reset.php?token=".$token."<br>
                 or you can click on this
                 <a href='http://localhost:80/project/client/forgot_pass_reset.php?token=".$token."'style=' background-color: #4CAF50;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;'>Click To Reset password</a>
                 <br>
